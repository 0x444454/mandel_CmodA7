...
If instead you have a __Cmod A7-15T__, you need to set ```NCORES = 7``` in the [fb_scanline_writer.sv](sources/src/fb_scanline_writer.sv) file, or you will run out of DSPs.  
