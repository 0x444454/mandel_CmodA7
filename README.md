...
- Make sure you __twisted__ each of the 4 HDMI pairs together (i.e. P and N signals). Have 0.5 to 1 twist per cm (1.25 to 2.5 twists per inch).
...
- Remove possible sources of electromagnetic interference around our "contraption" :-)
- Try with a different display. Unfortunately, I have a limited amount of displays to test (3 out of 3 are working).
